...
CREATE TABLE meter(
                      ...
                      `read_num` DECIMAL(24,2) NOT NULL  COMMENT '装表读数' ,
                      `rate` DECIMAL(24,2) NOT NULL  COMMENT '倍率' ,
                      `range` DECIMAL(24,2) NOT NULL  COMMENT '量程' ,
...
CREATE TABLE meter_reading_record(
                                     ...
                                     `start_num` DECIMAL(24,2) NOT NULL  COMMENT '起数' ,
                                     `end_num` DECIMAL(24,2) NOT NULL  COMMENT '止数' ,
                                     `rate` DECIMAL(24,2) NOT NULL  COMMENT '倍率' ,
                                     `amount` DECIMAL(24,2) NOT NULL  COMMENT '数量' ,
...
CREATE TABLE table_change_record(
                                    ...
                                    `old_start_num` DECIMAL(24,2) NOT NULL  COMMENT '原表止数' ,
                                    `old_usage` DECIMAL(24,2) NOT NULL  COMMENT '原表用量' ,
                                    `new_num` VARCHAR(255) NOT NULL  COMMENT '新表号' ,
                                    `new_start_num` DECIMAL(24,2) NOT NULL  COMMENT '新表起数' ,
...
CREATE TABLE proprietor(
                           ...
                           `updated_time` DATETIME   COMMENT '更新时间' ,
                           `phone` VARCHAR(255) NOT NULL  COMMENT '联系手机号' ,
                           `amount` DECIMAL(24,2)   COMMENT '预收金金额' ,
                           PRIMARY KEY (id)
)  COMMENT = '业主';
...
CREATE TABLE room(
                     ...
                     `area` DECIMAL(24,2) NOT NULL  COMMENT '建筑面积' ,
                     `usage_area` DECIMAL(24,2)   COMMENT '使用面积' ,
                     PRIMARY KEY (id)
)  COMMENT = '房间';
...
CREATE TABLE charge_project(
                               ...
                               `unit_cost` DECIMAL(24,2) NOT NULL  COMMENT '计算单价' ,
...
CREATE TABLE charge_manage(
                              ...
                              `deferred_amonut` DECIMAL(24,2) NOT NULL  COMMENT '缓交金额' ,
                              `derate_amount` DECIMAL(24,2) NOT NULL  COMMENT '减免金额' ,
                              `breach_amount` DECIMAL(24,2) NOT NULL  COMMENT '违约金额' ,
                              `discount_amount` DECIMAL(24,2) NOT NULL  COMMENT '优惠金额' ,
                              `read_income_amount` DECIMAL(24,2) NOT NULL  COMMENT '实收金额' ,
                              `remark` VARCHAR(255)   COMMENT '备注' ,
                              PRIMARY KEY (id)
)  COMMENT = '收费管理';
...
CREATE TABLE receive_manage(
                               ...
                               `amount` DECIMAL(24,2) NOT NULL  COMMENT '数量' ,
                               `unit` DECIMAL(24,2) NOT NULL  COMMENT '单价' ,
                               `rate` DECIMAL(24,2) NOT NULL  COMMENT '倍率' ,
                               `receive_amount` DECIMAL(24,2) NOT NULL  COMMENT '应收金额' ,
...
CREATE TABLE refund_record(
                              ...
                              `refund_amount` DECIMAL(24,2) NOT NULL  COMMENT '退款金额' ,
...
CREATE TABLE revocation_record(
                                  ...
                                  `revocation_amount` DECIMAL(24,2) NOT NULL  COMMENT '撤销金额' ,
...
CREATE TABLE mitigate_record(
                                ...
                                `mitigate_amount` DECIMAL(24,2) NOT NULL  COMMENT '减免金额' ,
